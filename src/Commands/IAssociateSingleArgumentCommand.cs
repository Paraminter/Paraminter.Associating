...
/// <summary>Represents a command to associate a single argument with a parameter.</summary>
...
public interface IAssociateSingleArgumentCommand<out TParameter, out TArgumentData>
    : ICommand
